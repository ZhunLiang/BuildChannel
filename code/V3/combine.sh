...
if($SAVETEMP==1){
  ...
  system "cp Wall.gro Wall.top IonChannel.top IonChannel.gro tune_end.gro tune_end.top scale.gro scale.top temp_out";
}

if($DEL==1){
  system "rm -f Wall.gro Wall.top IonChannel.top IonChannel.gro tune_end.gro tune_end.top scale.gro scale.top";
}
