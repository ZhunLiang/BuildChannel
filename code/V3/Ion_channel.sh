...
if($DeletePairNum!=0){ 
     system "PYTHON ~/bin/DelMole.py -i IonMulti.gro -F $FirstIonAtom -S $SecondIonAtom -n $RealPairNum -d $DeletePairNum -o IonMultiDel.gro ";
...
system "PYTHON ~/bin/SortMole.py -i IonMultiDel.gro -F $FirstIonAtom -S $SecondIonAtom -s $IonPairNum -t $NeedPairNum -o temp.gro";
